...
/**
 * A loader for templates stored on the file system either by
 * relative or absolute path.
 *
 * @author <a href="mailto:jvanzyl@apache.org"></a>
*  @author <a href="mailto:dskolovos@hotmail.com">Dimitrios Kolovos</a> based on
*  code of Jason van Zyl
 * @version $Id: AbsoluteFileResourceLoader.java,v 1.0 2004/03/03 23:23:02
 */
    ...
    extends ResourceLoader
{
    ...
    private InputStream findTemplate(String path, String template)
    {
        try
        {
            ...
            // ---------------------
            // Based on the original FileResourceLoader
            // Modified in order to accept absolute file
            // names as well. If the file is not found
            // using the relative paths mechanism, try to
            // find it by using its full name
            // ---------------------

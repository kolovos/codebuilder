...
public class DefaultSystemEditDocumentAction
    extends AbstractDocumentAction {

  Document document = null;

  public DefaultSystemEditDocumentAction(Document document){
    super();
  ...
  private void init() {
    putValue(Action.NAME, "Default System editor");
    putValue(Action.SHORT_DESCRIPTION,
             "Opens the current document for editing using the system editor (windows-only)");
